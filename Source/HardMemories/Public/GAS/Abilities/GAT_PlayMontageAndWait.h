 ...
 */
UCLASS()
class HARDMEMORIES_API UGAT_PlayMontageAndWait : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	static UGAT_PlayMontageAndWait* PlayMontageAndWaitForEvent(
...
private:
	...
	class UBaseAbilitySystemComponent* GetTargetASC();
